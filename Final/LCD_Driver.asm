...
; ***************************************************************
; **                                                            *
; ** Using Starter Code from Xilinx, written by      *
; **															*
; ***************************************************************
...
PS2_Data_Present_input_port	EQU	$30			;
PS2_ascii_input_port	EQU	$40		     ;
...
; *************
main: 
                    CALL      Check_PS2_Present       ; constantly , check buttons
                    CALL	check_UART_rx
                    JUMP      main
...
Check_PS2_Present:
		IN 	s0, PS2_Data_Present_input_port
		LOAD	s1, $01
		SUB	s1, s0
		JUMP	Z, Check_PS2_Data
		
		RET
		
Check_PS2_Data:
		IN	s5,PS2_ascii_input_port
		LOAD	s1, $01
		SUB		s1, s5
		JUMP	Z, Exit_PS2
